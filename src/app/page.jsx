      ...
      <section className='min-h-screen  w-full lg:pt-10 pb-0 flex flex-col justify-center items-center lg:flex-row items-center '>
        ...
        <div className='w-full flex flex-col  justify-center lg:justify-around lg:w-[50vw] lg:h-auto lg:p-12 pt-[20px] lg:pt-[50px]'>
          ...
          {/* <div className='w-full flex justify-around' >
            <div className='flex flex-col'><span className='text-[#FF0000] text-[16px]'>Experiencia</span></div>
            <div className='flex flex-col'><span className='text-[#FF0000] text-[16px]'>Celeridad</span></div>
          </div> 
              ...
              userDB && userDB.services !== undefined && userDB.services.map((i, index) =>
                <div key={index}>
                  ...
                  <div className="inline-flex items-center justify-center w-full">
                    <hr className="w-64 h-px my-8 bg-[#FF0000] border-0 dark:bg-gray-700" />
                    <span className="absolute px-3 font-medium text-[#003b99] -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900 z-0">•</span>
                  </div>
                </div>
              )
            }
       ...
       <section className='w-full pt-[70px]' id="Referencia">
        ...
        <div className='lg:grid lg:grid-cols-2 lg:gap-4 py-5 mt-5'>
          ...
          <ul className='border-l-2 border-[#01C89E] pl-5 pt-5 pb-5 flex flex-col justify-center '>
            {
              userDB && userDB.articles !== undefined && Object.keys(userDB.articles).map((i, index) => <List i={i} url={userDB.articles[i] && userDB.articles[i]['url']} title={userDB.articles[i]['titulo de #Referencia']} key={index} />
              )
            }
          </ul>
        </div>
          ...
          <ul className='min-w-[80%] grid grid-cols-1 gap-4'>
            {
              userDB && userDB.services !== undefined && userDB.services.map((i, index) =>
                <div key={index}>
                  ...
                  <div className="inline-flex items-center justify-center w-full">
                    <hr className="w-64 h-px my-8 bg-[#FF0000] border-0 dark:bg-gray-700" />
                    <span className="absolute px-3 font-medium text-[#FF0000] -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900 z-0">•</span>
                  </div>
                </div>
              )
            }
