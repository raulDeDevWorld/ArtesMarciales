    ...
    userDB && <main className="flex min-h-screen w-full flex-col items-center justify-between px-5">
      ...
      <section className='min-h-screen  w-full lg:pt-10 pb-0 flex flex-col justify-center items-center lg:flex-row items-center '>
        ...
        <div className='w-full flex flex-col  justify-center lg:justify-around lg:w-[50vw] lg:h-auto lg:p-12 pt-[20px] lg:pt-[50px]'>
          ...
          <br />
          <div>
            <h1 className='w-full text-center text-[20px] lg:text-[22px]'><span className='text-[#b80000] font-bold'>{userDB.frontPage['nombre']}</span><span className='text-[#002663] font-bold	'>{userDB.frontPage['apellidos']}</span></h1>
            <h1 className='w-full text-center text-[20px] lg:text-[22px]'><span className='text-[#b80000] font-bold'>{userDB.frontPage['especialidad 1']} </span><span className='text-[#002663] font-bold	'>{userDB.frontPage['especialidad 2']}</span></h1>
          </div>
          <br />
