...
export default function Navbar({ children }) {
    ...
    return (
        <nav className="w-screen fixed top-0 z-10 ">
            <div className="max-w-screen flex flex-wrap items-center justify-between bg-[#191F4F] border-b-[10px] border-[#EED7EB] mx-auto p-4 z-[1000]">
            ...
            {<div className={`absolute top-[70px] w-1/2  transition-all z-0 ${nav ? 'right-0' : 'right-[-550px]'} lg:w-auto lg:right-[35px] lg:top-[0px] lg:flex lg:h-[60px]`} >
                <ul className="h-[250px] lg:h-auto flex flex-col justify-around bg-[#191F4F] font-bold p-4 lg:p-0 mt-4 border border-gray-100 rounded-lg  lg:flex-row lg:space-x-8 lg:mt-0 lg:border-0 lg:flex-row lg:items-center">
                    <li>
