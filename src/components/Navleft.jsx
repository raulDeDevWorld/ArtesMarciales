    ...
    return (
        <>
            {user && <div className={`fixed right-[20px] transition-all ease-in-out duration-300 ${add ? 'bottom-[150px] lg:bottom-[73px]' : 'bottom-[-250px] lg:bottom-[73px]'} z-30`}>
                ...
                <button type="button" onClick={() => { setUserItem(undefined); funcion('Referencia') }} className="h-[50px] w-[50px] my-1 text-blue-700 bg-gray-950 border border-gray-700 flex- hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-gray-500 font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
